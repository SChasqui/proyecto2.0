...
public class Sprite {
	...
	public static final int DEFENZA = 6;
	...
	public Sprite(String nombre) {
		...
		for (int i = 0; i < tamanhos[DEFENZA]; i++) {
			spritesDerecha[DEFENZA][i] = (new ImageIcon("data/Sprites/" + nombre + "/ataquePequeñoDerecha/" + (i + 1)+".png")).getImage();
		}
		...
		//***************************************
		spritesIzquierda = new Image[9][7];
		...
		for (int i = 0; i < tamanhos[DEFENZA]; i++) {
			spritesIzquierda[DEFENZA][i] = (new ImageIcon("data/Sprites/" + nombre + "/ataquePequeñoIzquierda/" + (i + 1)+".png")).getImage();
		}
		for (int i = 0; i < tamanhos[RECARGA_KI]; i++) {
